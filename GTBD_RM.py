...
def consol():
    ...
    df_main = df_main[[TRICS_nayose_columns[0], TRICS_nayose_columns[1], TRICS_columns[0], TRICS_columns[1], TRICS_columns[2], TRICS_columns[3], TRICS_columns[4], TRICS_columns[5], TRICS_nayose_columns[-2],
    ...
    # Create df_main_1 containing RM Remitter details using df_main
    ...
    # Create df_main_2 containing RM Beneficiary details using df_main
...
TRICS_nayose_columns = ['COUNTRY_FROM', 'COUNTRY_TO', 'COUNTRY_FROM_2', 'COUNTRY_TO_2', 'REMITTING_BANK_JP_BANK_GRP_2', 'BENEFICIARY_BANK_JP_BANK_GRP_2', 
                         'REMITTER_ENGLISH', 'REMITTER_C_CIF', 'BENEFICIARY_ENGLISH', 'BENEFICIARY_C_CIF', 'REMITTER_NAYOSE_FLG', 'BENEFICIARY_NAYOSE_FLG']
TRICS_cust_columns = ['REMITTER_ENGLISH', 'BENEFICIARY_ENGLISH']
#df_1, df_gdwh = return_table_data(TRICS_nayose_columns, 'trics_rm_worldwide_201807', 1000, 0, GDWH_columns) # Update filename accordingly
#df_2, df_gdwh = return_table_data(TRICS_nayose_columns, 'trics_rm_worldwide_201808', 1000, 0, GDWH_columns) # Update filename accordingly
#df_3, df_gdwh = return_table_data(TRICS_nayose_columns, 'trics_rm_worldwide_201809', 1000, 0, GDWH_columns) # Update filename accordingly
...
df_main_1.to_excel(r'Y:\MRDD_Temp\%s_RM_REMITTER.xlsx' % datetime.datetime.now().strftime('%Y%m%d'))
df_main_2.to_excel(r'Y:\MRDD_Temp\%s_RM_BENEFICIARY.xlsx' % datetime.datetime.now().strftime('%Y%m%d'))

#df_main = pd.read_excel(r'Y:\MRDD_Temp\20181109_RM.xlsx')
#df_main.drop_duplicates(subset = [TRICS_columns[0], TRICS_columns[1], TRICS_columns[4]], inplace = True)
#df1 = df_.copy()
#del df1['BENEFICIARY_ENGLISH'], df1['REMITTING_BANK_JP_BANK_GRP_2'], df1['BENEFICIARY_BANK_JP_BANK_GRP_2'], df1['REMITTER_C_CIF'], df1['BENEFICIARY_C_CIF'], df1['REMITTER_NAYOSE_FLG'], df1['BENEFICIARY_NAYOSE_FLG']
#df1 = df1[['COUNTRY_FROM_2', 'COUNTRY_TO_2', 'REMITTER_ENGLISH', 'COUNTRY_FROM', 'COUNTRY_TO']]
#df1['COUNTRY_FROM_2'] = df1['COUNTRY_FROM_2'].str.replace('NETHERLANDS', 'NETHERLAND')
#df1['COUNTRY_TO_2'] = df1['COUNTRY_TO_2'].str.replace("LAO PEOPLES", "LAO PEOPLE'S")
#df_main_1 = pd.merge(df_main, df1, how = 'left', on = ['COUNTRY_FROM_2','COUNTRY_TO_2', 'REMITTER_ENGLISH'])
#df_main_1 = df_main_1[[TRICS_nayose_columns[0], TRICS_nayose_columns[1], TRICS_columns[0], TRICS_columns[1], TRICS_columns[2], TRICS_columns[3], TRICS_columns[4], TRICS_columns[5], TRICS_nayose_columns[-2],
#                  'PYTHON_COMPANY_A_BEST_MATCH', 'PYTHON_CCIF_A_BEST_MATCH', 'PYTHON_A_HIGHEST_RATIO', 'PYTHON_A_UPDATE_TAG',
#                  TRICS_columns[6], TRICS_columns[7], TRICS_nayose_columns[-1],
#                  'PYTHON_COMPANY_B_BEST_MATCH', 'PYTHON_CCIF_B_BEST_MATCH', 'PYTHON_B_HIGHEST_RATIO', 'PYTHON_B_UPDATE_TAG']]
#del df_main_1[TRICS_columns[3]], df_main_1[TRICS_columns[6]], df_main_1[TRICS_columns[7]], df_main_1[TRICS_nayose_columns[-1]]
...
#df_main_1['PYTHON_A_HIGHEST_RATIO'] = df_main_1['PYTHON_A_HIGHEST_RATIO'].astype(float)
#df_main_1.sort_values(by = 'PYTHON_A_HIGHEST_RATIO', ascending = False, inplace = True)
#df_main_1.drop_duplicates(subset = [TRICS_nayose_columns[0], TRICS_nayose_columns[1], TRICS_columns[0], TRICS_columns[1], TRICS_columns[4]], inplace = True)
#df_main_1.index = np.arange(1, len(df_main_1) + 1)
#df_main_1.to_excel(r'Y:\MRDD_Temp\%s_RM_REMITTER.xlsx' % datetime.datetime.now().strftime('%Y%m%d'))

#df_main = pd.read_excel(r'Y:\MRDD_Temp\20181109_RM.xlsx')
#df_main.drop_duplicates(subset = [TRICS_columns[0], TRICS_columns[1], TRICS_columns[6]], inplace = True)
#df1 = df_.copy()
#del df1['REMITTER_ENGLISH'], df1['REMITTING_BANK_JP_BANK_GRP_2'], df1['BENEFICIARY_BANK_JP_BANK_GRP_2'], df1['REMITTER_C_CIF'], df1['BENEFICIARY_C_CIF'], df1['REMITTER_NAYOSE_FLG'], df1['BENEFICIARY_NAYOSE_FLG']
#df1 = df1[['COUNTRY_FROM_2', 'COUNTRY_TO_2', 'BENEFICIARY_ENGLISH', 'COUNTRY_FROM', 'COUNTRY_TO']]
#df_main_2 = pd.merge(df_main, df1, how = 'left', on = ['COUNTRY_FROM_2', 'COUNTRY_TO_2', 'BENEFICIARY_ENGLISH'])
#del df_main_2[TRICS_columns[2]], df_main_2[TRICS_columns[4]], df_main_2[TRICS_columns[5]], df_main_2[TRICS_nayose_columns[-2]]
#del df_main_2['PYTHON_COMPANY_A_BEST_MATCH'], df_main_2['PYTHON_CCIF_A_BEST_MATCH'], df_main_2['PYTHON_A_HIGHEST_RATIO'], df_main_2['PYTHON_A_UPDATE_TAG']
#df_main_2['PYTHON_B_HIGHEST_RATIO'] = df_main_2['PYTHON_B_HIGHEST_RATIO'].astype(float)
#df_main_2.sort_values(by = 'PYTHON_B_HIGHEST_RATIO', ascending = False, inplace = True)
#df_main_2.drop_duplicates(subset = [TRICS_nayose_columns[0], TRICS_nayose_columns[1], TRICS_columns[0], TRICS_columns[1], TRICS_columns[6]], inplace = True)
#df_main_2.index = np.arange(1, len(df_main_2) + 1)
#df_main_2.to_excel(r'Y:\MRDD_Temp\%s_RM_BENEFICIARY.xlsx' % datetime.datetime.now().strftime('%Y%m%d'))